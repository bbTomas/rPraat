...
for (I in seq_along(listFiles)) {
    ...
    fileTextGrid <- paste0(inputFolder, "/", paste0(fileName, ".TextGrid"))
    filePitchTier <- paste0(inputFolder, "/", paste0(fileName, ".PitchTier"))
    fileSound <- paste0(inputFolder, "/", paste0(fileName, ".wav"))
